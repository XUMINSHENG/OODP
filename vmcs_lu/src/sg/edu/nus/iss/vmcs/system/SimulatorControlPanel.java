...
/**
 * This panel is displayed when the system is started up&#46; It enables the
 * user (the Controller) to: <br>
 * 1- Start (switch on); <br>
 * 2- Stop (switch off); <br>
 * 3- Activate the Customer Panel; <br>
 * 4- Activate the Maintenance Panel; <br>
...
public class SimulatorControlPanel extends Frame {
	...
	public SimulatorControlPanel(SimulationController controller) {
		...
		addButton(SIMUL_BEGIN, L_SIMUL_BEGIN, new BeginSimulationButtonListener(simulationCtrl));
		addButton(ACT_CUSTOMER, L_ACT_CUSTOMER, new ActivateCustomerPanelButtonListener(simulationCtrl));
		addButton(ACT_MAINTAINER, L_ACT_MAINTAINER, new ActivateMaintainerPanelButtonListener(simulationCtrl));
		addButton(ACT_MACHINERY, L_ACT_MACHINERY, new ActivateMachineryPanelButtonListener(simulationCtrl));
		addButton(SIMUL_END, L_SIMUL_END, new EndSimulationButtonListener(mainCtrl));
	 ...
	 * 
	 * @param isOn
	 *            TRUE to turn on the simulation, FALSE to turn off the
	 *            simulation.
	 */
	 ...
	 * @param state
	 *            the state of the button&#46; TRUE to enable it, FALSE to
	 *            disabled it&#46;
	 */
