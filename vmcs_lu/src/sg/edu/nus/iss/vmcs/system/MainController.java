...
/**
 * This object is the main controller of the vending machine&#46; It coordinates
 * the main operations of the VMCS&#46;
 *
...
public class MainController {
	...
	/**
	 * This method will initiate the creation of all the control objects
	 * necessary for simulation of the vending machine, and initiate the display
	 * of the SimulatorControlPanel (the main menu).
	 * 
	 ...
	 * 
	 * @throws VMCSException
	 *             if fail to load drinks properties or cash properties.
	 */
	...
	/**
	 * This method destroys all the object instances created for opening the
	 * vending machine&#46; It will instruct the SimulationController to close
	 * down (by closing down all the vending machine panels) and the
	 * TransactionController to close down&#46; It will also close down other
	 * control objects and the entity objects created for simulating the vending
	 * machine&#46;
	 */
