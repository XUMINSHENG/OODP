...
/**
 * This control object implements the interface, PropertyLoader, to provide the
 * generic functionality required to initialize the stores.
 *
...
public abstract class FilePropertyLoader implements PropertyLoader {
	 ...
	 * 
	 * @throws IOException
	 *             if fail to store properties to properties file.
	 */
