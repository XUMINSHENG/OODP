...
/**
 * This control object represents the operating system user interface at which
 * the VMCS application can be launched.
 *
...
public class SimulationController {
	 ...
	 * <br>
	 * 1- Create and display the panel&#46; <br>
	 * 2- Activate the Begin Simulation Button&#46; <br>
	...
	/**
	 * This method will instruct all four panels of the vending machine to close
	 * down when instructed by the MainController&#46;
	 */
	public void stop() {
		mCtrl.closeDown();
	}
	...
	/**
	 * This method is triggered when the Begin Simulation Button is pressed on
	 * the SimulatorControlPanel&#46; It will start the simulation of the
	 * vending machine by activating the three panel buttons namely; Active
	 * Customer Panel Button, Activate Maintainer Panel Button, and Activate
	 * Machinery Simulator Button&#46;
	 */
	public void start() {
	...
	/**
	 * If FALSE is passed the Begin Simulation Button is enabled and the other
	 * buttons of the SimulatorControlPanel are disabled&#46; If TRUE is passed
	 * the Begin Simulation Button is disabled and the other buttons of
	 * SimulatorControlPanel are enabled&#46;
	 * 
	 * @param vl
	 *            the active status of the simulation&#46;
	 */
	...
	/**
	 * Setup the Machinery Simulator Panel&#46; This will be achieved as
	 * follows: <br>
	 * 1- Deactivate the Activate Machinery Simulator Button&#46; <br>
	 * 2- Display Machinery Simulator Panel with initial values set&#46; <br>
	...
	/**
	 * Setup the Maintenance Panel&#46; This will be achieved as follows: <br>
	 * 1- Send a message to deactive the Activate Maintainer Panel Button&#46;
	 * <br>
	 * 2- Send a message to instruct all its constituent objects to display
	 * themselves, and also instruct them all, except for Password Box to become
	 * deactivated&#46;
	 */
	...
	/**
	 * Setup the Customer Panel&#46; This will be achieved as follows: <br>
	 ...
	 * constituent interface objects&#46; <br>
