...
/**
 * This control object monitors the ActivateMachinerySimulatorPanel Button and
 * performs actions in response to the button being pressed.
 *
...
public class ActivateMachineryPanelButtonListener implements ActionListener {
	 ...
	 * ActivateMachinerySimulatorPanelButtonListener
	 * 
	 * @param ct
	...
	/**
	 * This method performs actions in response to the Activate Machinery Panel
