...
/**
 * This entity object holds the environment settings used to configure the
 * system.
 *
...
public class Environment {
	...
	/**
	 * This method reads-in the environment setting from a properties file and
	...
	public static void initialize(String propFile) throws VMCSException {
		try {
			...
			throw new VMCSException("Environment.initialize", "Error loading environment properties: " + e);
		}
	}

	/**
	 * This method returns the name/ location of the DrinksStore properties
	 * file.
	 * 
