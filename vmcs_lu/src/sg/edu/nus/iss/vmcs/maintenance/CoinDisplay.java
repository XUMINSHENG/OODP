...
/**
 * This interface object is part of the Maintenance Panel&#46; It is used by the
 * Maintainer to display the total number of Coins of each denomination that are
 * currently held in the CashStore&#46; The object contains buttons to represent
 * (and select) the Coin denominations used in the vending machine&#46;
 *
...
public class CoinDisplay extends Panel {
	...
	/**
	 * This method activates the CoinDisplay if the parameter is TRUE&#46;
	 * Otherwise, the CoinDisplay is deactivated.
	 * 
	 * @param st
	 *            the active status of the CoinDisplay.
	 */
	...
	/**
	 * Get the current displayed coin index&#46 This is used for updating when
	 * store MachinerySimulatorPanel is changed. Not required.
	 */
