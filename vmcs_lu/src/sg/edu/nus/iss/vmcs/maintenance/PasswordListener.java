...
/**
 * This control object monitors the events in the Password Box and performs
 * actions in response to data being entered into the text field.
 *
...
public class PasswordListener implements ActionListener {
	...
	/**
	 * This method performs actions in response to the password text field being
	 * entered.
	 * 
	 * @param e
	 */
