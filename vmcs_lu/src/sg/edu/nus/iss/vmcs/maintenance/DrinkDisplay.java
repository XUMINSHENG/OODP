...
/**
 * This interface object is part of the MaintenancePanel&#46; It is used by the
 * Maintainer to display the total number of cans of each DrinksBrand that are
 * currently held in the DrinksStore&#46; This object contains buttons which
 * represent (and to select) the DrinksBrand served by the vending machine.
 *
...
public class DrinkDisplay extends Panel {
	...
	/**
	 * This method set the active status of the LabelledDisplay and
	 * ButtonItemDisplay.
	 * 
	 * @param st
	 *            the active status of the LabelledDisplay and
	 *            ButtonItemDisplay.
	 */
	...
	/**
	 * This method displays the stock value received for the currently selected
	 * brand. This display will be done on a text field associated with the
	 * DrinkDisplay object.
	 * 
	 * @param idx
