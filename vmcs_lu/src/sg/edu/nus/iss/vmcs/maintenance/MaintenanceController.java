...
public class MaintenanceController {
	...
	/**
	 * This method sets whether the maintainer login&#46; When the
	 * MaintenanceController receives a message saying that the Maintainer has
	 * successfully logged-in, the following will occur; <br>
	 * 1- Messages will be sent to activate the following elements of the
	 * MaintenancePanel: CoinDisplay, DrinkDisplay, TotalCashDisplay,
	 * ExitButton, Transfer Cash Button and Total Cash Button&#46; <br>
	 * 2- The Door will be instructed to set its status as unlocked, and then
	 * inform the MachinerySimulatorPanel to update the Door Status Display&#46;
	 * <br>
	 * 3- The SimulatorControlPanel will be instructed to deactivate the
	 * ActivateCustomerPanelButton&#46; <br>
	 * 4- The TransactionController will be instructed to terminate and suspend
	 * Customer Transactions&#46 Operation TerminateTransaction of
	 * TransactionController will be used to accomplish this&#46
	 * 
	 * @param st
	 *            If TRUE then login successfully, otherwise login fails.
	 */
	...
	/**
	 * This method will be used to get the total number of coins of a selected
	 * denomination&#46 This method invoked in CoinDisplayListener.
	 * 
	 * @param idx
	...
	/**
	 * This method will get the drink stock value and prices (for a specific
	 * brand) for display&#46 This method invoked in DrinkDisplayListener.
	 * 
	 * @param idx
	 *            the index of the drinks.
	 */
	...
	/**
	 * This method sends the total cash held in the CashStore to the
	 * MaintenancePanel&#46 This method is invoked by the
	...
	/**
	 * This method is to facilitate the transfer of all cash in CashStore to the
	 * maintainer&#46 This method is invoked by the
	 * TransferCashButtonListener&#46 It get all the cash from store and set
	 * store cash 0.
	 */
	...
	/**
	 * When the MaintenanceController receives a message saying that the
	 * Maintainer has correctly logged-out, the following will occur: <br>
	 * 1- Check the door status of Door to determine whether the vending machine
	 * door is locked&#46 if the door is unlocked, then the exit request is
	 * ignored&#46 <br>
	 * 2- Re-set the MaintenancePanel (initial values set, buttons activated/
	 * deactivated)&#46 <br>
	 * 3- Update the CustomerPanel and permit Customer transaction to
	 * re-start&#46 This method is invoked by the exit button listener.
	 */
	...
	/**
	 * This method will close down the maintenance functions of the vending
	 * machine&#46 This method close down the MaintenancePanel.
	 */
