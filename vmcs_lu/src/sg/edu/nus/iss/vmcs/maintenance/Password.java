...
public class Password {
	...
	/**
	 * This method compare the received Password with the authorized password
	 * string stored in the object, and then return a message to the
	 * AccessManager saying whether the password is valid or invalid.
	 * 
	 * @param psi
	...
	public boolean validatePassword(String psi) {
		...
		// The input password psi is compared to the correct one from the
		// property file.
