...
/**
 * This entity object implements a generic Store&#46; It has methods to load
 * (add) {@link StoreItem} into the Store and release {@link StoreItem} from the
 * Store.
 * 
 * @see CashStore
 * @see CashStoreItem
...
public abstract class Store {
	...
	/**
	 * This method returns the {@link StoreItem} corresponding to the index
	 * entered.
	 * 
	...
	/**
	 * This method finds a {@link StoreObject} in the store with a specified
	 * name&#46;
	 * 
	 * @param name
	 *            the name of the Store Object&#46;
	 * @return the Store Object&#46; Return null if no matching Store Object
	 *         found&#46;
	 */
	 ...
	 * 
	 * @param idx
	 *            the index of the store item.
	 * @param qty
	 *            the quantity of the store item.
	 */
