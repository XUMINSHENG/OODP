...
public class CashStore extends Store {
	...
	/**
	 * This method find and returns the index of the coin in the CashStore of
	 * the given Coin&#46;
	 * 
	 * @param c
	 *            the Coin of interest&#46;
	 * @return the index of the given Coin&#46; Return -1 if unknown Coin is
	 *         detected.
	 */
	...
	/**
	 * This method determine whether the given weight of the {@link Coin} is
	 * valid.
	 * 
	 * @param weight
	 *            the weight of the Coin to be tested.
	...
	/**
	 * This method will locate a {@link Coin} denomination held, with the input
	 * data (coin weight)&#46; If found, it returns an existence identifier
	 * (reference)&#46; Otherwise, it informs the requestor that the coin is
	 * invalid.
	 * 
	 * @param weight
	 *            the weight of the coin to be found.
