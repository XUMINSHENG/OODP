...
/**
 * This interface provides the generic functionality required to initialize the
 * stores.
 * 
 * @see CashStore
 * @see CashStoreItem
...
public interface PropertyLoader {
	 ...
	 * 
	 * @throws IOException
	 *             if fail to read properties from properties file.
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if fail to save properties to properties file.
	 */
	public void saveProperty() throws IOException;

	/**
	 * This method returns the number of items (either CashStoreItem or
	 * DrinkStoreItem) stored in the hash table.
	 * 
	...
	/**
	 * This method sets the number of items (either CashStoreItem or
	 * DrinkStoreItem) stored in the hash table.
	 * 
	 * @param numItems
	 *            the number of items.
