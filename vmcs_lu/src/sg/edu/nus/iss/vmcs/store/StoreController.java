...
public class StoreController {
	 ...
	 * 
	 * @throws IOException
	 *             if fail to initialize stores; reading properties.
	 */
	...
	/**
	 * This method initiates the initialization of the {@link DrinkStore} and
	 * {@link CashStore} from data read-in from an input file.
	 * 
	 * @throws IOException
	 *             if fail to initialize stores; reading properties.
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if fail to initialize drinks store; reading properties.
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if fail to initialize cash store; reading properties.
	 */
	...
	/**
	 * This method will instruct the {@link CashStore} to store the {@link Coin}
	 * sent as input, and update the display on the Machinery Simulator Panel.
	 * 
	 * @param c
	 *            the Coin to be stored.
	 */
	...
	/**
	 * This method return the total size of the {@link Store} of the given type
	 * of {@link Store}.
	 * 
	 * @param type
	 *            the type of the Store (either CASH or DRINK).
	...
	/**
	 * This method returns an array of {@link StoreItem} of the given type of
	 * {@link Store}.
	 * 
	 * @param type
	 *            the type of Store.
	...
	/**
	 * This method will either: <br>
	 * - instruct the {@link CashStore} to update the quantity of a {@link Coin}
	 * denomination to new value supplied and update the total cash held in the
	 * {@link CashStore}; or <br>
	 * - instruct the {@link DrinksStore} to update the drinks stock for a
	 * {@link DrinksBrand} required to a new value supplied.
	 * 
	 * @param type
	 *            the type of Store.
	 * @param idx
	...
	/**
	 * This method returns the {@link StoreItem} with the given {@link Store}
	 * type and index of {@link StoreItem}.
	 * 
	 * @param type
	 *            the type of Store.
	 * @param idx
	...
	/**
	 * This method will sets the price for the {@link StoreItem} with the given
	 * index and price.
	 * 
	 * @param idx
	 *            the index of the StoreItem.
	 * @param pr
	 *            the price of the StoreItem.
	 */
	...
	/**
	 * This method returns the total number of cash held in the
	 * {@link CashStore}.
	 * 
	...
	/**
	 * This method will instruct the {@link CashStore} to store the {@link Coin}
	 * sent as input, and then update the display on the
	 * {@link sg.edu.nus.iss.vmcs.machinery.MachinerySimulatorPanel}.
	 * 
	...
	/**
	 * This method will close down the store management function of the vending
	 * machine. This involves saving the attributes of the stores to the
	 * property file.
	 * 
	 * @throws IOException
	 *             if fail to save cash properties and drinks properties.
	 */
	...
	/**
	 * This method saves the attributes of the {@link CashStore} to the input
	 * file.
	 * 
	 * @throws IOException
	 *             if fail to save cash properties.
	 */
	...
	/**
	 * This method saves the attributes of the {@link DrinksStore} to the input
	 * file. It saves the drink property when simulation is ended.
	 * 
	 * @throws IOException
	 *             if fail to save drinks properties.
	 */
	...
	/**
	 * This method instructs the {@link DrinksStore} to dispense one drink, and
	 * then updates the
	 * {@link sg.edu.nus.iss.vmcs.machinery.MachinerySimulatorPanel}&#46; It
	 * returns TRUE or FALSE to indicate whether dispensing was successful&#46;
	 * 
	 * @param idx
	 *            the index of the drinks to be dispensed&#46;
	 */
	...
	/**
	 * This method returns a {@link Store} of a specified type (i&#46;e&#46;
	 * Cash or Drink)&#46;
	 * 
	 * @param type
	 *            the type of Store&#46;
	...
	/**
	 * This method instructs the {@link CashStore} to issue a number of
	 * {@link Coin} of a specific denomination, and then updates the
	 * {@link sg.edu.nus.iss.vmcs.machinery.MachinerySimulatorPanel}&#46; It
	 * return TRUE or FALSE to indicate whether the change issue was
	 * successful&#46;
	 * 
	 * @param idx
