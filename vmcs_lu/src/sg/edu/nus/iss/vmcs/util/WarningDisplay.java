...
/**
 * This interface object class implements a generic display label&#46; It
 * provides for setting the background and foreground colors for display labels,
 * and to set their state to on or off&#46;
 *
...
public class WarningDisplay extends Panel {
	 ...
	 *            background color when ON&#46;
	 * @param offFg
	 *            foreground color when OFF&#46;
	 * @param offBg
	 *            background color when OFF&#46;
	 */
	public WarningDisplay(String label, Color onFg, Color onBg, Color offFg, Color offBg) {
	 ...
	 * 
	 * @param isOn
	 *            TRUE to set the warning display to On, otherwse, to Off.
	 */
