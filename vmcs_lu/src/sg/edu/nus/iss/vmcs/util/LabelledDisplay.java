...
public class LabelledDisplay extends Panel {
	 ...
	 * 
	 * @param listener
	 *            the ActionListener for the display.
	 */
	...
	/**
	 * This method sets whether the TextField in the LabelledDisplay is
	 * editable.
	 * 
	 * @param v
	 *            TRUE making it editable, FALSE making it not editable.
	 */
	 ...
	 * 
	 * @param st
	 *            the active status of the LabelledDisplay.
	 */
