...
public class LabelledValue extends Panel {
	 ...
	 *            the label name.
	 * @param value
	 *            the value of the updatable label.
	 * @param width
	 *            the width of the updatable label.
	 */
	public LabelledValue(String name, String value, int width) {
		...
		add(lbl1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 0, 0), 1, 0));
		add(lbl2, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
	 ...
	 * 
	 * @param i
	 *            the value to be set to the text field&#46;
	 */
