...
public class MachineryController {
	...
	/**
	 * This method will close down the machinery functions of the vending
	 * machine.
	 */
	 ...
	 * 
	 * @param state
	 *            TRUE to set the state to open, otherwise, set the state to
	 *            closed.
	 */
	 ...
	 * 
	 * @throws VMCSException
	 *             if fail to update drinks store display.
	 */
	...
	/**
	 * This method update coin stock view after transfer all cash&#46; This
	 * method will get the stock values of coin denominations from the CashStore
	 * and display them on the MachinerySimulatorPanel.
	 * 
	 * @throws VMCSException
	...
	/**
	 * This method will instruct the CashStore to store the Coin sent as input,
	 * and update the display on the MachinerySimulatorPanel.
	 * 
	 * @param c
	 * @throws VMCSException
	 *             if fail to update cash store display.
	 ...
	 * updates the MachinerySimulatorPanel.&#46; It returns TRUE or FALSE to
	 * indicate whether dispensing was successful.
	 * 
	 * @param idx
	 *            the index of the drinks store item.
	 * @throws VMCSException
	 *             if fail to update cash store display.
	 */
	...
	/**
	 * This method instructs the CashStore to issue a number of coins of a
	 * specific denomination, and hen updates the MachinerySimulatorPanel&#46;
	 * It returns TRUE or FALSE to indiate whether the change issue was
	 * successful.
	 * 
	 * @param idx
	 *            the index of the cash store item.
	 * @param numOfCoins
	 *            the number of coins to change.
	 * @throws VMCSException
	 *             if fail to update cash store display.
	 */
