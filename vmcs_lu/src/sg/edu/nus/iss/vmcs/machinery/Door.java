...
/**
 * This object represents the door of the vending machine&#46; It is opened so
 * that the machine can be re-stocked with cans and cash.
 *
...
public class Door {
	 ...
	 * 
	 * @param isClosed
	 *            TRUE to close the door, FALSE to open the door.
	 */
