...
/**
 * This boundary object enables a drink to be displayed and selected&#46; It
 * also displays the stock availability of the drink&#46;
 * 
 * @author Team SE16T5E
...
public class DrinkSelectionItem extends Panel {
	 ...
	 * @param isActive
	 *            the active status of the drink&#46;
	 * @param isWarningOn
	 */
	public DrinkSelectionItem(int drinkIdentifier, String drinkName, int drinkPrice, int quantity, boolean isActive,
			boolean isWarningOn) {
	...
	private void init() {
		...
		add(btn, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 10, 0, 0), 10, 4));
		add(lbl, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(5, 15, 0, 0), 50, 0));
		add(wnd, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
	 ...
	 * 
	 * @param isOn
	 *            TRUE to turn on the warning message and disable the button.
	 */
	...
	/**
	 * This method returns the item state of the DrinkSelectionItem&#46; This
	 * method determine whether the warning message is On or Off.
	 * 
	 ...
	 * 
	 * @param active
	 *            the active status of the DrinkSelectionItem; TRUE to activate
	 *            it, FALSE to deactive it.
	 */
