...
public class CoinReceiver {
	 ...
	 * <ol>
	 * <li>The Coin Input Box will be instructed to become deactivated&#46;</li>
	 * <li>The weight of the Coin will be send to the object Coin for it to
	 * determine the denomination and value&#46;</li>
	 * <li>The Total Money Inserted Display will be updated&#46;</li>
	 * <li>If an invalid coin is entered, the Invalid Coin Display will be
	 * instructed to display INVALID COIN&#46;</li>
	 * <li>The Transaction Controller will be informed to process the current
	 * transaction based on the money received&#46;</li>
	 * </ol>
	 * 
	 * @param weight
	 *            the weight of the coin received&#46;
	 */
	...
	/**
	 * This method will activate the Coin Input Box so that further coins can be
	 * received.
	 */
	...
	/**
	 * This method will deactivate the Coin Input Box in order to stop receiving
	 * coins.
	 */
	...
	/**
	 * This method handles the refunding of Coins entered so far to the
	 * Customer.
	 */
	 ...
	 * 
	 * @param active
	 *            TRUE to activate, FALSE to deactivate the Coin Input Box.
	 */
