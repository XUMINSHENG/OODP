...
public class CoinInputBox extends Panel {
	...
	public CoinInputBox(TransactionController cctrl) {
		...
		for (int i = 0; i < cashStoreItems.length; i++) {
			...
			add(btnCoinButton[i], new GridBagConstraints(i, 1, 1, 1, 1.0, 0.0, GridBagConstraints.EAST,
					GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 10, 8));
		}
		...
		add(btnCoinButton[cashStoreSize], new GridBagConstraints(cashStoreSize, 1, 1, 1, 1.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 10, 8));
	}
	 ...
	 * 
	 * @param active
	 *            TRUE to activate the CoinInputBox, otherwise, deactivate the
	 *            CoinInputBox.
	 */
