 ...
 * 
 * This panel simulates the vending machine's customer interface panel&#46; It
 * will enable the user (Customer) to:
 * <ol>
 * <li>insert coins;</li>
 * <li>select Brands;</li>
 * <li>terminate Transaction&#46;</li>
 * </ol>
 * It will also provide the following display functions;
 * <ol>
 * <li>display total money inserted.</li>
 * <li>indicate coin not valid.</li>
 * <li>indicate no change available.</li>
 * <li>display the value of the change to be collected.</li>
 * <li>display an icon representing the dispensed drink.</li>
 * </ol>
 *
 * @author Team SE16T5E
...
public class CustomerPanel extends Dialog {
	...
	/**
	 * This constructor creates an instance of the Customer Panel&#46; It
	 * further creates Invalid Coin Display, No Change Available Display,
	 * Refund/ Change Tray Display, Total Money Inserted Display, Coin Input
	 * Box, Drink Selection Box, Can Collection Box and Terminate Button.
	 * 
	 * @param fr
	 *            the parent frame
	 * @param ctrl
	...
	public CustomerPanel(Frame fr, TransactionController ctrl) {
		...
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent ev) {
				txCtrl.getMainController().getSimulatorControlPanel().setButtonState(SimulatorControlPanel.ACT_CUSTOMER,
						true);
				dispose();
		...
		pan0.add(lblEnterCoins, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(coinInputBox, new GridBagConstraints(0, 1, 0, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 0, 0, 0), 10, 0));
		pan0.add(wndInvalidCoin, new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(lbdTotalMoneyInserted, new GridBagConstraints(0, 3, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(drinkSelectionBox, new GridBagConstraints(0, 4, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(wndNoChangeAvailable, new GridBagConstraints(0, 5, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(btnTerminate, new GridBagConstraints(0, 6, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(lbdCollectCoins, new GridBagConstraints(0, 7, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 10, 0));
		pan0.add(lbdCollectCan, new GridBagConstraints(0, 8, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 0, 20, 0), 10, 0));
	...
	/**
	 * Display the Customer Panel&#46; This will be achieved by displaying the
	 ...
	 * 
	 * @param i
	 *            the money to be added to the accumulative total money
	 *            inserted.
	 ...
	 * 
	 * @param isOn
	 *            TRUE to turn on the highlight, otherwise, turn off the
	 *            highlight.
	 */
	...
	/**
	 * This method activates or deactivates the DrinkSelectionBox in the
	 * CustomerPanel.
	 * 
	 * @param active
	 *            the active status of the DrinkSelectionBox; TRUE to activate,
	 ...
	 * 
	 * @param active
	 *            the active status of the CoinInputBox; TRUE to activate, FALSE
	 *            to deactivate it.
	 */
	 ...
	 * 
	 * @param active
	 *            the active status of the Terminate Button; TRUE to activate,
	 *            FALSE to deactivate it.
	 */
	 ...
	 * 
	 * @param comp
	 *            the component to be activated or deactivated.
	 * @param st
	 *            the active status; TRUE to activate, FALSE to deactivate.
	 */
