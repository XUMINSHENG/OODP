...
/**
 * This control object monitors the selection of drink (drink brand) by a
 * customer in the Customer Panel. It performs an action in corresponding to the
 * drink selected.
 * 
 * @author Team SE16T5E
...
public class DrinkSelectionListener implements ActionListener {
	...
	/**
	 * This method performs actions in response to the drink button being
	 * pressed.
	 * 
	 * @param ev
	 */
