...
/**
 * This control object monitors the Terminate Button on the Customer Panel and
 * informs the Transaction Controller when it is pressed.
 * 
 * @author Team SE16T5E
...
public class TerminateButtonListener implements ActionListener {
	...
	/**
	 * This method performs actions in response to the terminate button being
	 * pressed.
	 * 
	 * @param ev
	 */
