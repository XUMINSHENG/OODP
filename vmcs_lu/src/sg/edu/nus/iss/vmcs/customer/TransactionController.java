...
public class TransactionController {
	 ...
	 * Panel&#46; The following actions are performed in the method: <br>
	 * 1- The price of the selected item is obtained&#46; <br>
	 * 2- The Refund/ Change Tray Display is reset&#46; <br>
	 * 3- The Can Collection Box is reset&#46; <br>
	 * 4- The Drink Selection Box is deactivated to disallow the selection of
	 * further drinks when the transaction is in progress&#46; <br>
	 * 5- The Coin Receiver will be instructed to start receiving the coins&#46;
	 * 
	 * @param drinkIdentifier
	 *            the drink brand item identifier.
	 */
	 ...
	 * the drink. The following actions are performed. <br>
	 * 1- Dispense the drink. <br>
	 ...
	 * transaction then following will occur: <br>
	 ...
	 * DrinkSelectionBox&#46; <br>
	 * 2- If coin input is not yet complete, the CoinReceiver will be instructed
	 * to stop coin input and refund the money entered so far&#46; <br>
	...
	public void refreshCustomerPanel() {
		/*
		 * if(custPanel==null){
		 * mainCtrl.getSimulatorControlPanel().setActive(SimulatorControlPanel.
		 * ACT_CUSTOMER,true); }
		 */
		dispenseCtrl.updateDrinkPanel();
		dispenseCtrl.allowSelection(true);
	 ...
	 * 
	 * @param changeGiven
	 *            TRUE the change is given, otherwise FALSE.
	 */
	 ...
	 * 
	 * @param drinkDispensed
	 *            TRUE the drink is dispensed, otherwise, FALSE.
	 */
